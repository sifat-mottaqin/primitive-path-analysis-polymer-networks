...
global FolderName FileTag TopologyFileTag...
    ...
    InputFileName OutputAtom OutputBond OutputSuccess...
...
OutputSuccess = [OutputDir,'/SUCCESS.',FileTag,'.ok'];
...
TimeStretchDataFileName = [CompiledFolderName,'/TimeAndRstar.',AddOn,FileTagCompiled,'.m'];
